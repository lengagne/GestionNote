...
ODS_API ods::Tag*	NumberDateStyle(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberDay(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberHours(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberMinutes(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberMonth(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberSeconds(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberTimeStyle(ods::Ns&, ods::Tag*);
ODS_API ods::Tag*	NumberYear(ods::Ns&, ods::Tag*);
